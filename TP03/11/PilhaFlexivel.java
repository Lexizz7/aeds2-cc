...
class Pilha {
    ...
    void inserirFim(String html) throws Exception {
        ...
        // Celula tmp será o novo topo, então ele precisa apontar para o topo antigo,
        // depois se tornar o topo
        tmp.prox = topo;
        topo = tmp;
        tmp = null;
    ...
    Filme removerFim() throws Exception {
        ...
        // Mover referencia do topo para o proximo em relação a ele
        topo = topo.prox;

        // apagar o topo antigo
        tmp.prox = null;
        tmp = null;
    ...
    void mostrar() throws Exception {
        // Como o topo referencia ao final da pilha (visto que é o topo que é inserido e
        // removido)
        // Precisa-se printar da base até o topo
        mostrar(topo, tamanho - 1);
    }

    void mostrar(Celula celula, int index) throws Exception {
        if (celula != null && index >= 0) {
            mostrar(celula.prox, index - 1);
