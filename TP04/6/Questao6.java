...
class Hash {
    // Com rehash, ou seja, sem reserva
    ...
    // Função rehash => aplica % de tamanho sobre o hash
    ...
    // insere nela mesmo, caso exista, executa rehash e tenta novamente
    ...
    public int indexOf(String chave) {
        ...
        if (tabela[pos] != null && chave.equals(tabela[pos].getTituloOriginal()))
            res = pos;
        else if (tabela[rehash(pos)] != null && chave.equals(tabela[rehash(pos)].getTituloOriginal()))
            res = rehash(pos);
